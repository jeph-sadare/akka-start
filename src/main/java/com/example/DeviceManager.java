...
public class DeviceManager extends AbstractBehavior<DeviceManager.Command> {
    ...
    private DeviceManager onTerminated(DeviceGroupTerminated terminated) {
        getContext().getLog().info(" [!] Device group actor for {} has been terminated", terminated.groupId);
        groupIdToActor.remove(terminated.groupId);
        return this;
    }
